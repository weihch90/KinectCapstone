 ...
 *
 * Verify that the specified mxArray is real, of type float, and has 
 ...
 *
 * Verify that the specified mxArray is 1-D, real, and of type float. The
 ...
 *
 * Verify that the specified mxArray represents a real float scalar value. 
